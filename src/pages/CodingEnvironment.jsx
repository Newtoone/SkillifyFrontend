    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <div className="text-center">
          <div className="animate-pulse bg-secondary-200 h-8 w-48 mx-auto rounded"></div>
          <div className="animate-pulse bg-secondary-200 h-64 w-full mx-auto mt-4 rounded"></div>
        </div>
      </div>
    )
  }
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="bg-white shadow-sm rounded-lg overflow-hidden">
        <div className="p-6 border-b">
          <h1 className="text-2xl font-bold text-secondary-800">{challenge.title}</h1>
              ...
              <div className="p-4">
                ...
                <div className="prose max-w-none">
                  ...
                  {challenge.examples.map((example, index) => (
                    <div key={index} className="mt-2 bg-secondary-50 p-3 rounded">
        ...
        {output && (
          <div className="p-6 border-t">
            ...
            <div className={`p-4 rounded ${
              output.status === 'Accepted' ? 'bg-green-50 text-green-800' : 'bg-red-50 text-red-800'
            }`}>
              ...
              {output.memoryUsage && (
                <p className="text-sm">
                  Memory usage: {output.memoryUsage}MB
                </p>
              )}
            </div>
          </div>
